...
const Contato = () => {
  return (
    <>
      ...
      >
        <div className="flex w-full max-w-[95vw] md:max-w-[85vw] lg:max-w-[100vw] flex-col items-center py-10 md:py-20 px-8 bg-gradient-to-r from-black to-black/95">
          <h2
            className={`${syne.className} bg-gradient-to-r from-neutral-600 via-slate-200 to-neutral-50 bg-clip-text text-center font-semibold lg:leading-10 tracking-tighter text-transparent text-2xl sm:text-3xl md:text-4xl lg:text-5xl max-w-[17ch] lg:max-w-[20ch]`}
          >
            <AnimatedWords title="Sinta-se a vontade para entrar em contato." />
          </h2>
          <motion.p
