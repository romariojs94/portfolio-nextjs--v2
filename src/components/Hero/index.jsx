...
const Hero = () => {
  return (
    <motion.main
      initial="initial"
      animate="animate"
      className="text-center h-[calc(100vh-80px)] flex flex-col justify-center items-center"
    >
      <h1 className="text-3xl break-all leading-none sm:text-5xl md:text-6xl lg:text-7xl font-extrabold mx-auto text-[#181717] lg:max-w-[16ch]">
        <AnimatedWords title="Desenvolvedor web & UI Designer" />
      </h1>
      <motion.p
        className="text-center text-base sm:text-lg text-[#525252]"
